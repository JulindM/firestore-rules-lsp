...
enum ts_symbol_identifiers {
  ...
  anon_alias_sym_param = 100,
  anon_alias_sym_pathPart = 101,
  anon_alias_sym_ret_expr = 102,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_alias_sym_ret_expr] = "ret_expr",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [anon_alias_sym_ret_expr] = anon_alias_sym_ret_expr,
};
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(119)] = 3392,
  [SMALL_STATE(120)] = 3399,
  [SMALL_STATE(121)] = 3406,
  [SMALL_STATE(122)] = 3413,
  [SMALL_STATE(123)] = 3420,
  [SMALL_STATE(124)] = 3427,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1, 0, 0),
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, 0, 2),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 2, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 2, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4, 0, 2),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4, 0, 2),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_member, 3, 0, 3),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_member, 3, 0, 3),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 1, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 1, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 1, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 1, 0, 0),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiplication, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multiplication, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_addition, 3, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_addition, 3, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional_or, 3, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional_and, 3, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indexing, 4, 0, 7),
  [131] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indexing, 4, 0, 7),
  ...
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0), SHIFT_REPEAT(108),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0),
  [176] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [179] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0), SHIFT_REPEAT(68),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_path, 1, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [188] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_match_path_repeat1, 2, 0, 0),
  [192] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_path_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_body, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 4, 0, 0),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 5, 0, 1),
  [209] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expr_list_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 3, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [216] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_body_repeat1, 2, 0, 0), SHIFT_REPEAT(104),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_body_repeat1, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_def, 3, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 8, 0, 8),
  [229] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 7, 0, 5),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 6, 0, 4),
  ...
  [247] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(84),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2, 0, 0),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2, 0, 0), SHIFT_REPEAT(85),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 9, 0, 10),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_list, 2, 0, 0),
  [259] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_def_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_def_repeat1, 2, 0, 0),
  ...
  [282] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_def_repeat1, 2, 0, 0), SHIFT_REPEAT(125),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0),
  [287] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0), SHIFT_REPEAT(95),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1, 0, 0),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path_segment, 3, 0, 12),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path_segment, 3, 0, 12),
  ...
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_def, 5, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path_segment, 1, 0, 6),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path_segment, 1, 0, 6),
  ...
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_service_name, 2, 0, 0),
  ...
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_body, 3, 0, 9),
  ...
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_body, 4, 0, 11),
