...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, 0, 0),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3, 0, 0),
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiplication, 3, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multiplication, 3, 0, 0),
  ...
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary, 2, 0, 1),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary, 2, 0, 1),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary, 2, 0, 2),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary, 2, 0, 2),
  ...
  [177] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0), SHIFT_REPEAT(116),
  ...
  [185] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_body_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  ...
  [202] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_path_repeat1, 2, 0, 0), SHIFT_REPEAT(70),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 7, 0, 3),
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expr_list_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 8, 0, 4),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 7, 0, 0),
  ...
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_def, 3, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 3, 0, 0),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_list, 2, 0, 0),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 9, 0, 5),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_def, 4, 0, 0),
  [246] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_def_repeat1, 2, 0, 0),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_def_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2, 0, 0),
  [257] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2, 0, 0), SHIFT_REPEAT(89),
  [260] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_body_repeat1, 2, 0, 0), SHIFT_REPEAT(107),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_body_repeat1, 2, 0, 0),
  [265] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [267] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(91),
  ...
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0),
  [280] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  ...
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1, 0, 0),
  [291] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_def_repeat1, 2, 0, 0),
  [293] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_def_repeat1, 2, 0, 0), SHIFT_REPEAT(128),
  [296] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0),
  ...
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_def, 5, 0, 0),
  [308] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path_segment, 3, 0, 6),
  [312] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path_segment, 3, 0, 6),
